...
// Function to render the table with the current list of students
function showTable() {
...
// Function to search a student to the list . 
function search() {
...
// Function to edit a student to the list
...
function edit(id) {
  ...
  // Function to delete a student to the list
function del(id) {
